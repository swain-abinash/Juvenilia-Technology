...
const PhoneIcon = () => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M22 16.92v3a2 2 0 0 1-2.18 2h-1.64a2 2 0 0 1-1.82-1.39l-2-6a2 2 0 0 1 1.76-2.73 1.99 1.99 0 0 1 .49-.12l4-1a2 2 0 0 1 1.48 2.05z"></path>
    <path d="M12.9 8.28a2 2 0 0 1 2.83 0l2.5 2.5a2 2 0 0 1 0 2.83l-5 5a2 2 0 0 1-2.83 0l-2.5-2.5a2 2 0 0 1 0-2.83z"></path>
  </svg>
);
const MailIcon = () => (
  <svg
  ...
  return (
    <div className="text-center">
      ...
      <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto">
        Have a project in mind or need expert IT solutions? We’d love to hear
        from you. Get in touch with our team today, and let’s explore how we can
...
const ContactInfo: React.FC = () => {
  const handleWhatsAppClick = () => {
    const message =
      "Hi! I'm interested in your services. Can we discuss my project requirements?";
  ...
  const handleEmailClick = () => {
    window.open(
      "mailto:support@juveniliatechnology.com?subject=Project Inquiry",
      "_self"
    );
  };
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-stretch">
        ...
        >
          <WhatsAppIcon />
          <h3 className="text-base md:text-lg font-semibold text-green-500 mt-4">
            WhatsApp
          </h3>
        ...
        >
          <PhoneIcon />
          <h3 className="text-base md:text-lg font-semibold text-orange-500 mt-4">
            Phone
          </h3>
        ...
        {({ isSubmitting }) => (
          <>
            ...
            <Form className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <input type="hidden" name="formType" value="userresponse" />
