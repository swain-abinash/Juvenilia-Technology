    ...
    <>
      <div className="w-full bg-gradient-to-r from-[#1b1b1b] via-[#222] to-[#1b1b1b] text-white border-b border-orange-500/10 shadow-[0_1px_10px_rgba(0,0,0,0.2)]">
        <div className="max-w-[1600px] mx-auto flex justify-between items-center py-2.5 px-4 md:px-10 lg:px-16 text-sm">
          ...
          {/* Right - Contact Info */}
          <div className="flex items-center gap-4 text-gray-200 font-medium text-xs md:text-sm">
            {/* Phone */}
            <a
              href="tel:+919437010139"
              className="px-3 py-1.5 rounded-full bg-[#2a2a2a] border border-orange-400/30 text-orange-400 hover:bg-orange-500 hover:text-white hover:border-orange-500 transition-all duration-300 shadow-sm hover:shadow-[0_0_12px_rgba(255,100,0,0.5)]"
            >
              +91 9437010139
            </a>
            ...
            <a
              ...
              className="px-3 py-1.5 rounded-full bg-[#2a2a2a] border border-gray-500 text-gray-300 hover:border-orange-400 hover:text-orange-400 hover:shadow-[0_0_10px_rgba(255,100,0,0.4)] transition-all duration-300"
            >
